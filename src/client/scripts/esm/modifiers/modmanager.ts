import type { FullGame } from "../chess/logic/gamefile";
...
async function loadModList(modlist: Modname[] = ['atomic']) {
...
function setupModifiers(modList: Modname[] = ['atomic'], ...args: Parameters<SetupFunc>) {
