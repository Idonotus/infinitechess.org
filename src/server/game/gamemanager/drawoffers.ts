 ...
 */
function isDrawOfferOpen(game: Game) {
 ...
 */
function doesColorHaveExtendedDrawOffer(game: Game, color: Player) {
 ...
 */
function hasColorOfferedDrawTooFast(game: Game, color: Player) {
 ...
 */
function openDrawOffer(game: Game, color: Player) {
 ...
 * DOES NOT INFORM the opponent.
 */
function closeDrawOffer(game: Game) {
 ...
 */
function getLastDrawOfferPlyOfColor(game: Game, color: Player) {
